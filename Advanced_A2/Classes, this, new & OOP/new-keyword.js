...
// this refers to the specific instance being referred
function createUser(username, score){
    this.username = username
    this.score = score
}

// creating a custom function for createUser 
...
const two = new createUser("coffee", 25)
const one = createUser("tea", 250)
